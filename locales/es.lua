Locales['es'] = {
    ...
    ['civil_wear'] = 'Ropa de Agente Civil',
    ...
    ['licence_you_revoked'] = 'Revocaste ~b~%s~s~ de ~y~%s~s~',
    ['no_players_nearby'] = 'no hay jugadores cerca',
    ['being_searched'] = 'Estas siendo ~y~buscado~s~ por la ~b~Policia~s~, ENTREGATE!',
    -- Vehicle interaction
    ...
    ['impound_canceled_moved'] = 'Se ha cancelado la confiscacion porque el vehiculo se ha movido',
    ['impound_successful'] = 'Has confiscado el vehiculo',
    ['search_database'] = 'Informacion vehicular',
    ['search_database_title'] = 'Informacion vehicular - buscar por la patente',
    ['search_database_error_invalid'] = 'Informacion vehicular - Patente invalida',
    ['search_database_error_not_found'] = 'Informacion vehicular - Patente no registrada',
    ['search_database_found'] = 'Informacion vehicular - El vehiculo esta registado, dueño: ~b~%s~s~',
    -- ID Card Menu
    ['name'] = 'Nombre: %s',
    ['job'] = 'Trabajo: %s',
    ['sex'] = 'Sexo: %s',
    ...
    ['got_confiscated'] = '~y~%sx~s~ ~b~%s~s~ confiscada por ~y~%s~s~',
    ...
    ['unrestrained_timer'] = 'Las esposas se estan soltando lentamente.',
    -- Notifications
